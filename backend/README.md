...
## Project Structure
    ...
    ├── lingering_silence_29494  # Django project configurations
...
1. Clone this repo and `cd lingering_silence_29494`
...
2. Clone this repo and `cd lingering_silence_29494`
